...
(1)$\lim\limits_{x \to 0}  \dfrac{{\tan x - x}}{{x - \sin x}} = \lim\limits_{x \to 0}  \dfrac{{{{\sec }^2}x - 1}}{{1 - \cos x}} = \lim\limits_{x \to 0}  \dfrac{{1 + \cos x}}{{{{\cos }^2}x}} = 2$
...
\begin{flalign*} \indent
    \begin{split}
    (7)\lim\limits_{x \to 0}  \dfrac{{1 - \cos {x^2}}}{{{x^2} - {{\tan }^2}x}}
    &= \dfrac{1}{2}\lim\limits_{x \to 0}  \dfrac{{{x^4}}}{{(x + \tan x)(x - \tan x)}}
    = \dfrac{1}{2}\lim\limits_{x \to 0}  \dfrac{x}{{x + \tan x}} \cdot \dfrac{{{x^3}}}{{x - \tan x}}\\
    &=\dfrac{1}{2} \cdot \dfrac{1}{2}\lim\limits_{x \to 0}  \dfrac{{3{x^2}}}{{1 - {{\sec }^2}x}}
    =  - \dfrac{3}{4}\lim\limits_{x \to 0}  \dfrac{{{x^2}}}{{{{\tan }^2}x}}
    =  - \frac{3}{4}.\\
    \end{split}&
\end{flalign*}

(8)$\lim\limits_{x \to 0}  \dfrac{{x - \arctan x}}{{{{\sin }^3}x}} = \lim\limits_{x \to 0}  \dfrac{{1 - \frac{1}{{1 + {x^2}}}}}{{3{x^2}}} = \lim\limits_{x \to 0}  \dfrac{{{x^2}}}{{3{x^2}(1 + {x^2})}} = \dfrac{1}{3}$
...
\begin{flalign*} \indent
    \begin{split}
    (12)\lim\limits_{x \to 0}  {(\dfrac{{\tan x}}{x})^{\frac{1}{{{x^2}}}}}
    &= \lim\limits_{x \to 0}  {e^{\frac{1}{{{x^2}}} \cdot \ln \dfrac{{\tan x}}{x}}} = {e^{\lim\limits_{x \to 0}  \dfrac{{\frac{x}{{\tan x}} \cdot \dfrac{{{{\sec }^2}x \cdot x - \tan x}}{{{x^2}}}}}{{2x}}}}  \\
    &={e^{\lim\limits_{x \to 0}  \dfrac{{{{\sec }^2}x \cdot (x - \sin x\cos x)}}{{2{x^3}}}}} = {e^{\lim\limits_{x \to 0}  \dfrac{{1 - \cos 2x}}{{6{x^2}}}}} \\
    &= {e^{\lim\limits_{x \to 0}  \dfrac{1}{2} \cdot \dfrac{{{{(2x)}^2}}}{{6{x^2}}}}} = {e^{\frac{1}{3}}}\\
    \end{split}&
\end{flalign*}
...
(14)$\lim\limits_{x \to 0^+}  {e^{ - \tan \ln x}} = \lim\limits_{x \to 0^+}  {e^{ - \frac{{\sin x\ln x}}{{\cos x}}}} = {e^0} = 1$
...
\begin{flalign*}
    \begin{split}
    (2)\lim\limits_{x \to 0}  \dfrac{{\sqrt {1 + \tan x}  - \sqrt {1 + \sin x} }}{{x\ln (1 + x) - {x^2}}}
    & =  \lim\limits_{x \to 0}  \dfrac{{\tan x(1 - \cos x)}}{{x(\sqrt {1 + \tan x}  + \sqrt {1 + \sin x} ) \cdot [\ln (1 + x) - x]}}\\
    & = \dfrac{1}{4}\lim\limits_{x \to 0}  \dfrac{{2x}}{{\dfrac{1}{{1 + x}} - 1}} =  - \dfrac{1}{2}\\
    \end{split}&
\end{flalign*}

\begin{flalign*}
    \begin{split}
    (3)\lim\limits_{x \to 0^+}  \left( {2-}3^{{{\arctan }^2}\sqrt x } \right)^{\frac{2}{{\sin {x}}}}
    & = {e^{\lim\limits_{x \to 0^+}  \dfrac{2}{{\sin x}}\left( {2 - {3^{{{\arctan }^2}\sqrt x }}} \right)}}
    = {e^{\lim\limits_{x \to 0^+}  \dfrac{2}{{\sin x}}\left( {1 - {3^{{{\arctan }^2}\sqrt x }}} \right)}}\\
    & = {e^{ - 2\ln 3\lim\limits_{x \to 0^+}  \dfrac{{3{{\arctan }^2}\sqrt x  \cdot 2\arctan \sqrt x }}{{\cos x}} \cdot \dfrac{1}{{1 + x}}}}\\
    & = {e^0}
    = 1
    \end{split}&
\end{flalign*}
...
\begin{flalign*}
    \begin{split}
    (4)\lim\limits_{x \to +\infty}  \dfrac{{\ln (a + b{e^x})}}{{\sqrt {m + n{x^2}} }}(b > 0,n > 0)
    & = \lim\limits_{x \to +\infty}  \dfrac{b}{{\frac{a}{{{e^x}}} + b}} \cdot \dfrac{{\sqrt {m + n{x^2}} }}{{nx}} = \lim\limits_{x \to +\infty}  \dfrac{{\frac{{nx}}{{\sqrt {m + n{x^2}} }}}}{n}\\
    & =\lim\limits_{x \to +\infty}  \dfrac{1}{{\sqrt {\dfrac{m}{{{x^2}}} + n} }} = \dfrac{1}{{\sqrt n }}
    \end{split}&
\end{flalign*}
...
\begin{flalign*}
    ...
    & = \lim\limits_{x \to +\infty}  {x^2}\ln (x\sin \dfrac{1}{x})
    = \lim\limits_{x \to +\infty}  {x^2}(x\sin \dfrac{1}{x} - 1)
    = \lim\limits_{x \to 0^+}  \dfrac{1}{{{x^2}}}(\dfrac{{\sin x}}{x} - 1)\\
    & = \lim\limits_{x \to 0^+}  \dfrac{{\sin x - x}}{{{x^3}}}
    = \lim\limits_{x \to 0^+}  \dfrac{{\cos x - 1}}{{3{x^2}}}
    = \lim\limits_{x \to 0^+}  \dfrac{{ - \sin x}}{{6x}}
    = - 6
    \end{split}&
\end{flalign*}
...
\begin{flalign*}
    \begin{split}
    (7)\lim\limits_{x \to 0}  {\left( {\dfrac{{\arcsin x}}{{\rm{x}}}} \right)^{\frac{1}{{1 - \cos x}}}}
    &= {e^{\lim\limits_{x \to 0}  \frac{1}{{1 - \cos x}}\ln (\frac{{\arcsin x}}{x})}} = {e^{\lim \frac{1}{{1 - \cos x}}(\frac{{\arcsin x}}{x} - 1)}}\\
    & = {e^{\lim\limits_{x \to 0}  \frac{{\arcsin x - x}}{{x(1 - \cos x)}}}} = {e^{2\lim\limits_{x \to 0}  \frac{{\arcsin x - x}}{{{x^3}}}}} = {e^{2\lim\limits_{x \to 0}  \frac{{\frac{1}{{\sqrt {1 - {x^2}} }} - 1}}{{3{x^2}}}}}\\
    & = {e^{2\lim\limits_{x \to 0}  \frac{{1 - \sqrt {1 - {x^2}} }}{{3{x^2}\sqrt {1 - {x^2}} }}}} = {e^{2\lim\limits_{x \to 0}  \frac{{\frac{1}{2}{x^2}}}{{3{x^2}}}}}\\
...
$\lim\limits_{x \to 0}  \dfrac{{\cos x - {e^{ - \frac{{{x^2}}}{2}}}}}{{{x^4}}} =  - \dfrac{1}{{12}}$
...
由极限的夹逼性可知,$\lim\limits_{x \to 0}  {e^{ - \frac{1}{{\left| x \right|}}\left( {2 + \sin \frac{1}{x}} \right)}} = f\left( 0 \right) = 0$,从而$f\left( x \right)$在$x = 0$处连续.
...
应用洛必达法则得$\lim\limits_{x \to 1}  \left( {\dfrac{{\frac{1}{x} - 1}}{{\frac{{\left( {x - 1} \right)}}{x} + \ln x}}} \right) = \lim\limits_{x \to 1}  \left( {\dfrac{{\frac{{1 - x}}{x}}}{{\frac{{\left( {x - 1} \right) + x\ln x}}{x}}}} \right) = \lim\limits_{x \to 1}  \left( {\dfrac{{1 - x}}{{\left( {x - 1} \right) + x\ln x}}} \right)$
