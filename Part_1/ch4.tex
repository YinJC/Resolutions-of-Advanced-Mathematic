...
6.解析:金属丝的质量为$m = \displaystyle\int_0^a {kx\rd x = \mathop {\lim }\limits_{n \to \infty } } \frac{a}{n}\sum\limits_{i = 1}^n {k(0 + \frac{a}{n}} i) = \mathop {\lim }\limits_{n \to \infty } \frac{{k{a^2}}}{{{n^2}}}\frac{{n(n + 1)}}{2} = \frac{{k{a^2}}}{2}$
...
$= \dfrac{1}{2}(} x|_{\frac{\pi }{6}}^{\frac{\pi }{2}} - \dfrac{1}{2}\sin 2x|_{\frac{\pi }{6}}^{\frac{\pi }{2}}) = \dfrac{1}{2}(\dfrac{\pi }{3} + \dfrac{1}{2} \times \dfrac{{\sqrt 3 }}{2}) = \dfrac{\pi }{6} + \dfrac{{\sqrt 3 }}{8}$
...
\begin{flalign*} \indent
    ...
    & = \mathop {\lim }\limits_{n \to \infty } \dfrac{1}{n}\left[ {\ln (1 + \dfrac{1}{n}) + \ln (1 + \dfrac{2}{n}) +  \cdots  + \ln (1 + \dfrac{2}{n})} \right]\\
    & = \mathop {\lim }\limits_{n \to \infty } \sum\limits_{i = 1}^n {\ln (1 + \dfrac{i}{n})} \dfrac{1}{n} = \mathop {\lim }\limits_{\xi  \to {0^ + }} \displaystyle\int_\xi ^1 {\ln (1 + x)\rd x} \\
...
\begin{flalign*} \indent
    \begin{split}
    (2)\mathop {\lim }\limits_{n \to \infty } (\dfrac{1}{{4{n^2} - {2^2}}} + \dfrac{1}{{4{n^2} - {2^2}}} +  \cdots  + \dfrac{{n - 1}}{{4{n^2} - {n^2}}})
    & = \mathop {\lim }\limits_{n \to \infty } (\dfrac{{\frac{1}{n}}}{{4 - {{\left( {\frac{2}{n}} \right)}^2}}} + \dfrac{{\frac{2}{n}}}{{4 - {{\left( {\frac{3}{n}} \right)}^2}}} +  \cdots  + \dfrac{{\frac{{n - 1}}{n}}}{{4 - {{\left( {\frac{n}{n}} \right)}^2}}}) \times \frac{1}{n} \\
...
\begin{flalign*} \indent
    \begin{split}
    (5)A 
    &= \displaystyle\int_{\frac{1}{{10}}}^{10} {\left| {\ln x} \right|} 
...
\begin{flalign*} \indent
    \begin{split}
    (5)V 
    &= \displaystyle\int \rd V  = \displaystyle\int {\pi {x^2}}\rd y\\
...
\begin{flalign*} \indent
    ...
    & = \int_{{\theta _1}}^{{\theta _2}} {\dfrac{1}{{\sin \theta {{\cos }^2}\theta }}d\theta }  = \int_{{\theta _1}}^{{\theta _2}} {\dfrac{{{{\sin }^2} + {{\cos }^2}\theta }}{{\sin \theta {{\cos }^2}\theta }}\rd \theta } \\
    & = \int_{{\theta _1}}^{{\theta _2}} {(\dfrac{{\sin \theta }}{{{{\cos }^2}\theta }} + \csc \theta } )\rd \theta  = \dfrac{1}{{\cos \theta }}|_{{\theta _{ & 1}}}^{{\theta _2}} + \ln |\tan \dfrac{\theta }{2}||_{{\theta _1}}^{{\theta _2}}\\
...
\begin{flalign*} \indent
    \begin{split}
    (5)S &= 4\int_0^{\frac{\pi }{2}} {\sqrt {{{\varphi '}^2}\left( t \right) + {{\phi '}^2}(t)} \rd t}  = 4\int_0^{\frac{\pi }{2}} {\sqrt {{{\left( { - 3a{{\cos }^2}t\sin t} \right)}^2} + {{\left( {3a{{\sin }^2}t\cos t} \right)}^2}} \rd t} \\
    & = 4\int_0^{\frac{\pi }{2}} {3a\cos t\sin t\rd t}  = 4\int_0^{\frac{\pi }{2}} {\sin 2t\rd t}  = 6a\\
    \end{split}&
\end{flalign*} 
...
\begin{flalign*} \indent
    \begin{split}
    13.\text {解析:}w 
    &= \int_0^{15} {\pi {y^2}\rd x} \ell g(15 - x) = \int_0^{15} {\dfrac{4}{9}\ell g\pi {x^2}(15 - x)\rd x} \\
...
(1)$\int_1^{ + \infty } {\dfrac{1}{{{x^5}}}} \rd x = \frac{{ - 1}}{{4{x^4}}}_1^{ + \infty } = 0 + \frac{1}{4} = \frac{1}{4}(x > 1)$

(2)$\int_1^{ + \infty } {\dfrac{1}{{\sqrt[3]{x}}}} \rd x = \dfrac{3}{2}{x^{\dfrac{2}{3}}}_1^{ + \infty } =  + \infty $,所以发散

(3)$\int_0^{ + \infty } {e^{ - ax}}\rd x(a > 0)}  = \dfrac{{ - {e^{ - ax}}}}{a}_0^{ + \infty } = \dfrac{1}{a}$

(4)令$t\ =  - \sqrt x $,则$\int_0^{ + \infty } {{e^{ - \sqrt x }}\rd x}  = \int_0^{ - \infty } {2t{e^t}\rd t = 2t{e^t}}  - \int_0^{ - \infty } {2t\rd ({e^t})}  = 2(t - 1){e^t}_0^{ - \infty } = 2$

(5)令$t = \arctan x$,则$x = \tan t$

$\int_0^{ + \infty }{\dfrac{{\arctan x}}{{{{\left( {1 + {x^2}} \right)}^{\frac{3}{2}}}}}}= \int_0^{\frac{\pi }{2}} {t\cos t\rd t = t\sin t + \cos t} } _0^{\frac{\pi }{2}}= \dfrac{\pi }{2} - 1$

(6)$\int_0^{ + \infty } {{e^{ - pt}}\sin \omega t\rd t}  = \int_0^{ + \infty } {\dfrac{{ - 1}}{p}\sin \omega t\rd ({e^{ - pt}}) = \dfrac{{ - {e^{ - pt}}}}{p}\sin \omega t + \int_0^{ + \infty } {\dfrac{{{e^{ - pt}}}}{p}} } \omega \cos \omega t\rd t = $

$\dfrac{{ - {e^{ - pt}}}}{p}\sin \omega t + \int_0^{ + \infty } {\dfrac{{ - \omega }}{{{p^2}}}} \cos \omega t\rd ({e^{ - pt}}) = \dfrac{{ - {e^{ - pt}}}}{p}\sin \omega t - \dfrac{{\omega {e^{ - pt}}}}{{{p^2}}} + \int_0^{ + \infty } {\dfrac{{ - {\omega ^2}}}{{{p^2}}}{e^{ - pt}}\sin \omega t\rd t} $

所以$\int_0^{ + \infty } {{e}^{ - pt}}\sin \omega t\rd t = \dfrac{{{p^2}}}{{{\omega ^2} + {p^2}}}} (\dfrac{{ - {e^{ - pt}}}}{p}\sin \omega t - \dfrac{{\omega {e^{ - pt}}}}{{{p^2}}})_0^{ + \infty } = \dfrac{\omega }{{{\omega ^2} + {p^2}}}$

(7)$\int_{ - \infty }^{ + \infty } {\dfrac{1}{{{x^2} + 2x + 2}}\rd x}  = \int_{ - \infty }^{ + \infty } {\dfrac{1}{{{{(x + 1)}^2} + 1}}d(x + 1) = \arctan (x + 1)_{ - \infty }^{ + \infty }}  = \dfrac{\pi }{2} - ( - \dfrac{\pi }{2}) = \pi $

(8)令$x = \sin t,$则$\int_0^1 {\dfrac{x}{{\sqrt {1 - {x^2}} }}} \rd x = \int_0^{\frac{\pi }{2}} {\dfrac{{\sin t}}{{\cos t}}\cos tdt =  - \cos t_0^{\frac{\pi }{2}}}  = 1$
...
(2)令$x = \sin t$,则$\int_0^1 {\dfrac{{\ln x}}{{\sqrt {1 - {x^2}} }}} \rd x = \int_0^{\frac{\pi }{2}} {\dfrac{{\ln \sin t}}{{\cos t}}\cos t\rd t = \int_0^{\frac{\pi }{2}} {\ln \sin t\rd t = } }  - \dfrac{\pi }{2}\ln 2$

(3)$\int_0^\pi  {\dfrac{{x\sin x}}{{1 - \cos x}}\rd x}  = \int_0^\pi  {\dfrac{{x2\sin \frac{x}{2}\cos \frac{x}{2}}}{{2\sin \frac{x}{2}\sin \frac{x}{2}}}} \rd x = \int_0^\pi  {\dfrac{x}{{\tan \dfrac{x}{2}}}} \rd x,$

令$t = \dfrac{x}{2} \Rightarrow x = 2t$,则$\int_0^\pi  {\frac{x}{{\tan \frac{x}{2}}}} \rd x = 4\int_0^{\frac{\pi }{2}} {\dfrac{t}{{\tan t}}} \rd t$,由一式得$ = 2\pi \ln 2$.

4.解析:

(1)令$x = \tan t$,则$\int_0^{ + \infty } {\dfrac{1}{{{{(1 + {x^2})}^2}}}} \rd x = \int_0^{\frac{\pi }{2}} {\dfrac{1}{{{{(\sec t)}^4}}}} {(\sec t)^2}\rd t = \int_0^{\frac{\pi }{2}} {{{(\cos x)}^2}\rd x = \int_0^{\frac{\pi }{2}} {(\dfrac{1}{2}} }  + \dfrac{1}{2}\cos 2t)\rd t = \dfrac{t}{2} + \dfrac{1}{4}\sin 2t\left| {\begin{array}{*{20}{c}}
  {\frac{\pi }{2}} \\ 
  0 
\end{array}} \right. = \dfrac{\pi }{4}$

(2)令$u = \sqrt {\tan x}  \Rightarrow x = \arctan ({u^2})$,则$\int_0^{\frac{\pi }{2}} {\dfrac{{\rd x}}{{\sqrt {\tan x} }}}  = \int_0^{ + \infty } {\dfrac{2}{{1 + {u^4}}}} \rd u$

再令$t = \dfrac{1}{u} \Rightarrow u = \dfrac{1}{t},$则原式$ = \int_0^{ + \infty } {\dfrac{{2t^2}}}{{1 + {t^4}}}} \rd t,$

因为$\int_0^{ + \infty } {\dfrac{2}{{1 + {u^4}}}}\rd u = \int_0^{ + \infty } {\dfrac{{2t^2}}}{{1 + {t^4}}}} \rd t$

\begin{flalign*} \indent
    \begin{split}
    \text {所以}2\int_0^{ + \infty } {\dfrac{2}{{1 + {u^4}}}} \rd u 
    &= \int_0^{ + \infty } {\dfrac{{2 + 2u^2}}}{{1 + {u^4}}}} \rd u = 2\int_0^{ + \infty } {\dfrac{{1 + \frac{1}{{{u^2}}}}}{{{u^2} + \dfrac{1}{{{u^2}}}}}} \rd u 
    &= 2\int_0^{ + \infty } {\dfrac{{\rd (u - \frac{1}{u})}}{{{{(u - \frac{1}{u})}^2} + 2}}}\\
    & = 2 \cdot \dfrac{1}{{\sqrt 2 }}\arctan (\dfrac{{u - \frac{1}{u}}}{{\sqrt 2 }})_0^{ + \infty } 
    &= \sqrt 2 \pi \\
    \end{split}&
\end{flalign*}

所以原式等于$\int_0^{\frac{\pi }{2}} {\dfrac{{\rd x}}{{\sqrt {\tan x} }}}  = \int_0^{ + \infty } {\dfrac{2}{{1 + {u^4}}}} \rd u = \dfrac{{\sqrt 2 \pi }}{2}$
...
$\mathop {\lim }\limits_{x \to {0^ + }} {(x - 0)^{\frac{1}{2}}} \cdot \dfrac{1}{{\sqrt x \sqrt {1 - {x^2}} }} = \mathop {\lim }\limits_{x \to {1^ - }} \dfrac{1}{{\sqrt {1 - {x^2}} }} = 1$由柯西判别法可知,积分$\int_0^{\frac{1}{2}} {\dfrac{{\rd x}}{{\sqrt x \sqrt {1 - {x^2}} }}} $收敛.故而原积分收敛.

(11)$\int_2^ + \infty } {\dfrac{1}{{{x^3}\sqrt {{x^2} - 3x + 2} }}\rd x}  = \int_2^ + \infty } {\dfrac{1}{{{x^3}\sqrt {(x - 1)(x - 2)} }}\rd x}  = \int_2^3 {\dfrac{1}{{{x^3}\sqrt {(x - 1)(x - 2)} }}\rd x}  + \int_3^ + \infty } {d\frac{1}{{{x^3}\sqrt {(x - 1)(x - 2)} }}\rd x} $

$\mathop {\lim }\limits_{x \to {2^ + }} {(x - 2)^{\dfrac{1}{2}}} \cdot \dfrac{1}{{{x^3}\sqrt {(x - 1)(x - 2)} }} = \mathop {\lim }\limits_{x \to {2^ + }}  \cdot \dfrac{1}{{{x^3}\sqrt {(x - 1)} }} = \dfrac{1}{8}$,由柯西判别法可知,积分$\int_2^3 {\dfrac{1}{{{x^3}\sqrt {(x - 1)(x - 2)} }}\rd x} $收敛;

$\mathop {\lim }\limits_{x \to  + \infty } {x^3} \cdot \dfrac{1}{{{x^3}\sqrt {(x - 1)(x - 2)} }} = \mathop {\lim }\limits_{x \to  + \infty }  \cdot \dfrac{1}{{\sqrt {(x - 1)(x - 2)} }} = 0$
由柯西判别法可知,积分$\int_3^ + \infty } {\dfrac{1}{{{x^3}\sqrt {(x - 1)(x - 2)} }}\rd x} $收敛;故原积分收敛.

(13)$\mathop {\lim }\limits_{x \to  + \infty } {x^{\frac{3}{2}}} \cdot \left| {\dfrac{{x\sin x}}{{{x^3} + 2{x^2} + 5}}} \right| = \mathop {\lim }\limits_{x \to  + \infty } \dfrac{{{x^{\frac{5}{2}}}}}{{{x^3} + 2{x^2} + 5}} \cdot \left| {\sin x} \right| = \mathop {\lim }\limits_{x \to  + \infty } \dfrac{{{x^{ - \frac{1}{2}}}}}{{1 + 2{x^{ - 1}} + 5{x^{ - 3}}}} \cdot \left| {\sin x} \right| = 0$由柯西判别法可知,积分$\int_0^ + \infty } {\left| {\dfrac{{x\sin x}}{{{x^3} + 2{x^2} + 5}}} \right|\rd x} $收敛,原积分绝对收敛.

(15)$\mathop {\lim }\limits_{x \to {0^ + }} {x^{\frac{3}{4}}} \cdot \dfrac{{\ln \sin x}}{{\sqrt x }} = \mathop {\lim }\limits_{x \to {0^ + }} \dfrac{{\ln \sin x}}{{{x^{ - \frac{1}{4}}}}} = \mathop {\lim }\limits_{x \to {0^ + }} \dfrac{{\cos x}}{{ - \frac{1}{4}{x^{ - \frac{5}{4}}}\sin x}} = \mathop {\lim }\limits_{x \to {0^ + }} \dfrac{{\cos x}}{{ - \frac{1}{4}{x^{ - \frac{1}{4}}}}} = 0$由柯西判别法可知,原积分收敛.
...
$\mathop {\lim }\limits_{x \to {+} }\infty } {x^m}\dfrac{{\ln (1 + x)}}{{{x^n}}}{=}\left\{ \begin{gathered}
  \mathop {\lim }\limits_{x \to {+}\infty } \dfrac{{\ln (1 + x)}}{{{x^{n - m}}}} = \mathop {\lim }\limits_{x \to {+}\infty } \frac{1}{{(n - m){x^{n - m - 1}}(1 + x)}} = 0,n > m \hfill \\
  \mathop {\lim }\limits_{x \to {+}\infty } {x^{m - n}}\ln (1 + x) =  + \infty ,n \leqslant m \hfill \\ 
\end{gathered}  \right.$

当$m > 1$且$n > m$,即$n > 1$时,广义积分收敛;
当$m \leqslant 1,n \leqslant m,$即$0 < n \leqslant 1$时,广义积分发散;

$\therefore 0 < n \leqslant 1$时,积分$\int_0^{ + \infty } {\dfrac{{\ln (1 + x)}}{{{x^n}}}\rd x} $发散.

$n > 1$时,$x = 0$杀瑕点,$\int_0^{ + \infty } {\dfrac{{\ln (1 + x)}}{{{x^n}}}\rd x}  = \int_0^1 {\dfrac{{\ln (1 + x)}}{{{x^n}}}\rd x + } \int_1^{ + \infty } {\dfrac{{\ln (1 + x)}}{{{x^n}}}\rd x} $

$\mathop {\lim }\limits_{x \to {0^ + }} {(x - 0)^q}\dfrac{{\ln (1 + x)}}{{{x^n}}} = \left\{ \begin{gathered}
  0,n - m < 1 \hfill \\
  1,n - m = 1 \hfill \\
   + \infty ,n - m > 1 \hfill \\ 
\end{gathered}  \right.$
...
综上所述,当$1 < n < 2$时,积分$\int_0^{ + \infty } {\dfrac{{\ln (1 + x)}}{{{x^n}}}\rd x} $收敛,其余情况发散.
...
\begin{flalign*} \indent
    \begin{split}
    (1)\int_0^{\frac{\pi }{2}} {\dfrac{{x + \sin x}}{{1 + \cos x}}\rd x}  
    &= \int_0^{\frac{\pi }{2}} {\dfrac{x}{{2{{\cos }^2}\frac{x}{2}}}} \rd x - \int_0^{\frac{\pi }{2}} {\frac{{d(1 + \cos x)}}{{1 + \cos x}}} = \int_0^{\frac{\pi }{2}} {xd(\tan \frac{x}{2}) - \ln (1 + cox)\left| {_0^{\frac{\pi }{2}}} \right.}  \\
    &= (x\tan \dfrac{x}{2})\left| {_0^{\frac{\pi }{2}}} \right. - \int_0^{\frac{\pi }{2}} {\tan \dfrac{x}{2}\rd x + \ln 2 = \dfrac{\pi }{2}} \\
    \end{split}&
\end{flalign*}
...
\begin{flalign*} \indent
    \begin{split}
    (5)\int_0^{\frac{\pi }{2}} {\dfrac{{\sin x - 2\cos x}}{{3\sin x + \cos x}}} \rd x
    & = \int_0^{\frac{\pi }{2}} {\dfrac{{\frac{1}{{10}}(3\sin x + \cos x) - \dfrac{7}{{10}}(3\cos x - \sin x)}}{{(3\sin x + \cos x)}}\rd x}  = \dfrac{1}{{10}}\int_0^{\frac{\pi }{2}} {\rd x}  - \dfrac{7}{{10}}\int_0^{\frac{\pi }{2}} {\dfrac{1}{{3\sin x + \cos x}}} \\
...
$\mathop {\lim }\limits_{n \to \infty } \sum\limits_{i = 1}^n {{r_i}}  = \int_a^b {f(x)\rd x} .$
